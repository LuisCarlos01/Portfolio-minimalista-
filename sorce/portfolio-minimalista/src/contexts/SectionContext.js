...
export const SectionProvider = ({ children }) => {
  ...
  const animateSkillsSection = () => {
    ...
    if (section) {
          ...
          onComplete: () => {
            ...
            progressBars.forEach((bar, index) => {
              ...
              if (index < skillCards.length) {
                const skillLevel = skillCards[index].querySelector('.skill-percentage').textContent.replace('%', '');
                setTimeout(() => {
      ...
      console.log('Dimensões da seção skills:', section.getBoundingClientRect());
      console.log('Número de skill cards:', section.querySelectorAll('.skill-card').length);
    } else {
